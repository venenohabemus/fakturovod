...
@section('content')
    ...
    @php($reportedErrors = array_merge($report['mapping'] ?? [], $report['xsd'] ?? [], $report['postar'] ?? []))
    ...
    @if ($invoice->error_message !== null || $reportedErrors !== [])
        <div class="card">
            ...
            @foreach (['mapping' => 'Chyby mapovania', 'xsd' => 'XSD validácia', 'postar' => 'Validácia poštára (Peppol)'] as $section => $heading)
