...
- [x] Validátor: XSD (OASIS schémy vendorované v resources/schemas) · [ ] schematron sidecar (KoSIT — na stroji chýba Java/Docker) · [x] SK biznis kontroly + slovenské hlášky (`BusinessValidator` — IČ DPH mod 11, IČO, SK sadzby 23/19/5, kategórie DPH, Peppol polia, dátumy; beží na kanonickom modeli pred UBL)
